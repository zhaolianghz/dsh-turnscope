 ...
 */
export type InspectionSink = Pick<TraceRepository, 'putCheckpoint' | 'putCheckpointPath' | 'putObjectRecord' | 'getCheckpoint' | 'listCheckpointPaths' | 'listFileChanges' | 'putFileChange' | 'putSafetyVerdict' | 'getLatestVerdict'>;
...
export interface TurnInspector {
     ...
     */
    observe(turn: TurnRecord, workspace: TurnWorkspace, previousStatus: TurnStatus | undefined): Promise<InspectionResult | undefined>;
    /**
     ...
     */
    inspect(turn: TurnRecord, workspace: TurnWorkspace, options?: {
