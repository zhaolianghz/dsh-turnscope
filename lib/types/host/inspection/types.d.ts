 ...
 */
export type InspectionSink = Pick<TraceRepository, 'putCheckpoint' | 'putCheckpointPath' | 'putObjectRecord' | 'getCheckpoint' | 'listCheckpointPaths' | 'putFileChange' | 'putSafetyVerdict' | 'getLatestVerdict'>;
