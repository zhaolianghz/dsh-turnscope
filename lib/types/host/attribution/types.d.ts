 ...
 */
import type { Attribution, CheckpointPathState, CheckpointRecord, FileChange, FileToolHint } from '../domain/types.ts';
/**
...
export declare const ATTRIBUTIONS: readonly Attribution[];
